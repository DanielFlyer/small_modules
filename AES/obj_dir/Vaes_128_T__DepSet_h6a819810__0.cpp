...
VL_INLINE_OPT void Vaes_128_T___combo__TOP__aes_128__DOT__r1__t0__DOT__t0__0(Vaes_128_T* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaes_128__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vaes_128_T___combo__TOP__aes_128__DOT__r1__t0__DOT__t0__0\n"); );
    // Body
