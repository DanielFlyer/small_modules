...
VL_INLINE_OPT void Vtest_aes_128_T___combo__TOP__test_aes_128__DOT__uut__DOT__r1__t0__DOT__t0__0(Vtest_aes_128_T* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtest_aes_128__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_aes_128_T___combo__TOP__test_aes_128__DOT__uut__DOT__r1__t0__DOT__t0__0\n"); );
    // Body
